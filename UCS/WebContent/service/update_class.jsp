...
<%
	...
	String strService = "[Update CLASS Service]";
	String msg = "";
	String redirectURL = "";
...
<%
	...
	if (cls.getCOUNT() == 0) {
		...
		//cls.setAPPLY_DT(df.format(now));
		//cls.setCNCL_YN(strCNCL_YN);
		//if (strCNCL_YN.compareTo("Y") == 0) {
		//	cls.setCNCL_DT(df.format(now));
		//	cls.setCNCL_USER(strUSER_ID);
		//}

		//cls.setAPPROVE_YN(strAPPROVE_YN);
		//if (strAPPROVE_YN.compareTo("Y") == 0) {
		//	cls.setAPPROVE_DT(df.format(now));
		//	cls.setAPPROVE_USER(strUSER_ID);
		//}
